...
const HEADER_DELIVERY_HEIGHT = height / 100 * 28;
  ...
  return (
    <ParallaxScrollViewNormal
      ...
      <ThemedView style={styles.titleContainer}>
        <ThemedText style={styles.titleText}>Connect & deliver</ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="default" style={styles.stepText}> 
          Traveling somewhere? Pickup a package towards your destination, drop it off and get paid.
        </ThemedText>
      </ThemedView>
